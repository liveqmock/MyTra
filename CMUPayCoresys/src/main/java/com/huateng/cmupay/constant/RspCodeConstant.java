...
public class RspCodeConstant {
	...
	public enum Crm {
		...
		CRM_3A21("3A21", "主号绑定副号已超过最大绑定个数"), CRM_3A22("3A22",
				...
				"3A30", "签约协议号填写错误"), CRM_3A35("3A35", "该机构该业务暂未开通"), CRM_3A36("3A36", "该营销活动部存在"),
	 ...
	 */
	public enum Tmall{
		TMALL_030A01("030A01", "重发交易日期超过两天"), TMALL_013A34("013A34", "重复交易，该交易已处理成功"),TMALL_013A36("013A36", "该营销活动部存在"),
			TMALL_013A37("013A37", "营销活动已过期");
	...
	public enum Bank {
		...
		BANK_013A11("013A11", "证件类型不符"), BANK_013A12("013A12",
				...
				"接收方交易权限关闭"), /* BANK_013A30("013A30", "sessionid重复"), */BANK_013A34("013A34", "重复交易，该交易已成功"),
		...
		BANK_014A00("014A00", "缴费记录不存在"), BANK_014A01("014A01", "非本省用户"), BANK_014A02(
				...
				"014A08", "该笔交易正在处理中"),/*BANK_014A30("014A30", "正在处理中"),*/
		...
		BANK_015A00("015A00", "计费记录错误"), BANK_015A01("015A01", "扣款失败"), BANK_015A02(
				...
				"015A08", "超过每秒最大交易数量"), BANK_015A09("015A09", "系统繁忙"), /*BANK_015A14(
				"015A14", "网状网错误"),*/
