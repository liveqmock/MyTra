...
public class CommonConstant {
	...
	public enum BankOrgCode {
		CMCC("0001", "中国移动系统"), TMALL("0051", "浙江运营中心(天猫充值)")/*
							 * , CMB("0002", "招商银行"), CCB("0004", "建设银行"), SPDB(
							 * "0005", "浦发银行"), BOC("0006", "中国银行"),
							 * ICBC("0007", "工商银行"), BCOM( "0008", "交通银行")
							 */;
	...
	public enum CnlType {
		CmccOwn("00", "中国移动系统自主发起"), CmccHall("01", "移动营业厅"), CmccWeb("02",
				...
				"移动短信营业厅"), CmccSelfTerminals("05", "移动自助终端"), BankSystem("50",
				"银行系统自主发起"), BankEleChannel("51", "银行电子渠道"), BankHall("52",
				"银行营业厅柜面"), BankAtm("53", "银行ATM机"), BankPhoneBanking("54",
				"银行电话银行"), BankMessageBanking("55", "银行短信银行");
	...
	public enum TxnStatus {
		InitStatus("99", "初始"), TxnSuccess("00", "成功"), TxnFail("01", "失败"), TxnTimeOut("02", "超时");
	...
	public enum TmallTrans {
		Tmall01("012001", "（天猫）充值交易（过渡方案）"), Tmall02("012002",
				...
				"012004", "（天猫）充值交易状态查询（全网方案）"), Tmall05("022003", "（天猫）充值交易结果通知（全网方案）");
	...
	public enum MarketTrans{
		Market01("012051","移动商城充值交易请求"),Market02("012052","移动商城交易状态查询"),Market03("022051","移动商城交易结果通知");
		String value;
		String desc;
