...
public class BankUnbindReqVo {
	...
	@NotNull(message="IDType参数不正确")
	@Pattern(regexp="01|02|03|04",message="IDType参数不正确")
	private String IDType;
	//中国移动用户ID
	@CustomAnnotation(path = "Body.IDValue")
	@NotNull(message="IDValue参数不正确")
//	@Length(max=32,message="IDValue格式不正确")
	...
	@NotNull(message="subID参数不正确")
	@Pattern(regexp="[0-9]{22}",message="subID参数不正确")
