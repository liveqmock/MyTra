...
public class MobileShopQueryMsgReqVo extends BaseMsgVo{
	...
	@Pattern(regexp = "[0-9]{2}", message = "019A21:QueryType参数不正确")
	private String QueryType;
	
	@CustomAnnotation(path = "Body.OriReqSys")
	@NotNull(message="019A22:OriReqSys参数不正确")
	@Pattern(regexp = "[0-9]{4}", message = "019A22:OriReqSys参数不正确")
	private String OriReqSys;
	
	@CustomAnnotation(path = "Body.OriReqDate")
	@NotNull(message="019A23:OriReqDate参数不正确")
	@Pattern(regexp = "[0-9]{8}", message = "019A23:OriReqDate参数不正确")
	private String OriReqDate;
	
	@CustomAnnotation(path = "Body.OriReqTransID")
//	@NotNull(message="019A24:OriReqTransID参数不正确")
	@Pattern(regexp = "\\w{0,32}", message = "019A24:OriReqTransID参数不正确")
