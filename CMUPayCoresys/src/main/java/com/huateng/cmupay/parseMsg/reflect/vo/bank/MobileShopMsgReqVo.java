...
public class MobileShopMsgReqVo extends BaseMsgVo{
	...
	@NotNull(message="019A30:OrderID不能为空")
	@Pattern(regexp = "\\w{0,32}", message = "019A30:OrderID格式不正确")
	...
	@NotNull(message="019A32:IDType不能为空")
	@Pattern(regexp = "\\w{2}", message = "019A32:IDType格式不正确")
	private String IDType;//中国移动用户标识类型
	
	@CustomAnnotation(path = "Body.IDValue")
	@NotNull(message="019A33:IDValue不能为空")
//	@Pattern(regexp = "\\w{0,32}", message = "019A33:IDValue格式不正确")
	...
	@NotNull(message="019A34:HomeProv不能为空")
	@Pattern(regexp = "\\w{3}", message = "019A34:HomeProv格式不正确")
	private String HomeProv;//归属省份
	
	@CustomAnnotation(path = "Body.Payment")
	@NotNull(message="019A35:HomeProv不能为空")
	@Pattern(regexp = "\\d+", message = "019A35:Payment格式不正确")
	private String Payment;//订单总金额
	
	@CustomAnnotation(path = "Body.ChargeMoney")
	@NotNull(message="019A36:ChargeMoney不能为空")
	@Pattern(regexp = "\\d+", message = "019A36:ChargeMoney格式不正确")
	private String ChargeMoney; //订单的充值金额
	
	@CustomAnnotation(path = "Body.ProdCnt")
	@NotNull(message="019A37:ProdCnt不能为空")
	@Pattern(regexp = "[0-9]*", message = "019A37:ProdCnt格式不正确")
	private String ProdCnt;//订单中的产品数量
	
	@CustomAnnotation(path = "Body.ProdID")
	@NotNull(message="019A38:ProdID不能为空")
	@Pattern(regexp = "\\w{0,32}", message = "019A38:ProdID格式不正确")
	private String ProdID;//充值产品编号
	
	@CustomAnnotation(path = "Body.Commision")
	@NotNull(message="019A39:Commision不能为空")
	@Pattern(regexp = "\\d+", message = "019A39:Commision格式不正确")
	private String Commision;//佣金
	
	@CustomAnnotation(path = "Body.RebateFee")
	@NotNull(message="019A40:RebateFee不能为空")
	@Pattern(regexp = "\\d+", message = "019A40:RebateFee格式不正确")
	private String RebateFee;//积分返点费用
	
	@CustomAnnotation(path = "Body.ProdDiscount")
	@Pattern(regexp = "\\d+", message = "019A41:ProdDiscount格式不正确")
	private String ProdDiscount;//产品折减金额
	
	@CustomAnnotation(path = "Body.CreditCardFee")
	//选填字段不需要验证空值
	//@NotNull(message="019A42:CreditCardFee不能为空")
	@Pattern(regexp = "\\d+", message = "019A42:CreditCardFee格式不正确")
	private String CreditCardFee; //信用卡费用
	
	@CustomAnnotation(path = "Body.ServiceFee")
	@Pattern(regexp = "\\d+", message = "019A43:ServiceFee格式不正确")
	private String ServiceFee;//服务费用
	
	@CustomAnnotation(path = "Body.PayedType")
	@Pattern(regexp = "\\w{2}", message = "019A44:PayedType格式不正确")
	private String PayedType;//缴费类型
	
	@CustomAnnotation(path = "Body.ActivityNO")
	@Pattern(regexp = "\\w{0,32}", message = "019A45:ActivityNO格式不正确")
	...
	@Pattern(regexp = "\\w{0,32}", message = "019A47:Reserve1格式不正确")
	private String Reserve1;//保留字段1
	
	@CustomAnnotation(path = "Body.Reserve2")
	@Pattern(regexp = "\\w{0,32}", message = "019A48:Reserve2格式不正确")
	private String Reserve2;//保留字段2
	
	@CustomAnnotation(path = "Body.Reserve3")
	@Pattern(regexp = "\\w{0,32}", message = "019A49:Reserve3格式不正确")
	private String Reserve3;//保留字段3
	
	@CustomAnnotation(path = "Body.Reserve4")
	@Pattern(regexp = "\\w{0,32}", message = "019A50:Reserve4格式不正确")
