...
public class MobileShopQueryMsgResVo extends BaseMsgVo{
	...
	@NotNull(message="019A12:OriRcvDate参数不正确")
	@Pattern(regexp = "{8}", message = "019A12:OriRcvDate参数不正确")
	private String OriRcvDate;
	
	@CustomAnnotation(path = "Body.OriRcvTransID")
	@NotNull(message="019A13:OriRcvTransID参数不正确")
	@Pattern(regexp = "\\w{0,32}", message = "019A13:OriRcvTransID参数不正确")
