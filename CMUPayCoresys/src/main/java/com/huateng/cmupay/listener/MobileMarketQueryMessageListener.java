...
//					
				...
				System.out.println("===============================replyToDest:"+replyToDest+"================================");
				if (replyToDest != null) {
					...
					template.send(replyToDest, new MessageCreator() {
						public Message createMessage(Session session)
							...
							System.out.println("==============================send:"+msg.getStringProperty("senderid")+"==================================");
							System.out.println("==============================send:"+msg.getStringProperty("reqTxnSeq")+"==================================");
							return msg;
						}
					});
