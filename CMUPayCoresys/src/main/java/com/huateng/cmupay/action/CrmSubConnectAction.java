...
public class CrmSubConnectAction extends AbsBaseAction<CrmMsgVo, CrmMsgVo> {
	...
	public CrmMsgVo execute(CrmMsgVo paramData) throws AppBizException {
		...
		try {
			...
			// 主号码归属省
			ProvincePhoneNum mainProvincePhoneNum = findProvinceByMobileNumber(subBindMsgUpdateReqVo.getMainIDValue());
			...
			if (subProvince.equals(mainIdProvince)) {
				...
				subBindInfos.setSignCnlType(subBindInfo.getSignCnlType());
				subBindInfos.setSignOrgId(subBindInfo.getSignOrgId());
